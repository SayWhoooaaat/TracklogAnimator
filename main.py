...
outline_image, outline_metadata = get_outline(track_points, width=overlay_width)
...
animate_path(track_points, map_image, map_metadata, outline_image, fps, overlay_width)
